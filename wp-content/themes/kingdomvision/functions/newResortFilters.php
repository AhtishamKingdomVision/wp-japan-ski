      ...
      echo '<div class="guests-popover" id="guests-popover" role="dialog" onclick="event.stopPropagation()">';
        echo '<div class="g-row">';
          ...
          echo '<div class="g-counter">';
              echo '<button class="g-btn js-btn-adults-minus" onclick="adj(\'adults\', -1)" disabled>−</button>';
        ...
        echo '<div class="g-row">';
          ...
          echo '<div class="g-counter">';
              echo '<button class="g-btn js-btn-children-minus" onclick="adj(\'children\', -1)" disabled>−</button>';
